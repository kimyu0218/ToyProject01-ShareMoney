    ...
    <Router>
      ...
      <div style={{ paddingTop: '69px', minHeight: 'calc(100vh - 80px)' }}>
        <Switch>
          ...
          <Route exact path="/join/success/:travel_id" component={Auth(SuccessJoin, true)} />

          <Route exact path="/edit" component={Auth(EditPage, true)} />
          <Route exact path="/edit/success/:travel_id" component={Auth(SuccessEdit, true)} />
          <Route exact path="/detail/:travel_id/:currency_code" component={Auth(DetailPage, true)} />

          <Route exact path="/expense/:travel_id/:currency_code" component={Auth(ExpensePage, true)} />

          <Route exact path="/generate" component={Auth(GeneratePage, true)} />
          <Route exact path="/generate/success/:travel_id" component={Auth(SuccessGenerate, true)} />
